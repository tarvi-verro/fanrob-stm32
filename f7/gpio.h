...
/* The datasheet hints at the existence of this register, but doesn't spcify
 * it. */
/*struct gpio_brr {
	uint32_t pin0 : 1, pin1 : 1, pin2 : 1, pin3 : 1, pin4 : 1, pin5 : 1,
		 pin6 : 1, pin7 : 1, pin8 : 1, pin9 : 1, pin10 : 1, pin11 : 1,
...
_Static_assert (offsetof(struct gpio_reg, afr) == 0x20,
		"GPIO register boundary mismatch.");
